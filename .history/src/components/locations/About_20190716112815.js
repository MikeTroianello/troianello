    ...
    <div className='about'>
      ...
      <div id='table-div'>
        <table>
          <tr>
            <td>
              <img src={jsLogo} alt='js-logo' className='icons' />
              JavaScript
            </td>
            <td>
              <img
            ...
            <td>
              <img src={nodeLogo} alt='node-logo' className='icons' />
              Node.js
            </td>
            <td>
              <img src={mongoLogo} alt='mongodb-logo' className='icons' />
              MongoDB
            </td>
          </tr>
          <tr>
            ...
            <td>
              <img src={sassLogo} alt='sass-logo' className='icons' />
              SCSS
            </td>
          </tr>
        </table>
